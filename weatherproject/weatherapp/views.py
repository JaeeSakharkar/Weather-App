...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=d2363cedc7ced57dca201fd5af093ef5'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyC1_-JTPAY5MdjmKVo1dqvNiZdbjVvXCtM'

    SEARCH_ENGINE_ID = '00d6885a018d542c0'
